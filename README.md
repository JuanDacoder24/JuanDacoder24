👨‍💻 Juan David Servellón — Desarrollador de Aplicaciones Web

Formandome con enfoque en desarrollo backend y frontend, diseño de bases de datos y creación de aplicaciones modernas. Apasionado por la tecnología, el aprendizaje continuo y las buenas prácticas de desarrollo.
...
Aplicación completa para la gestión de instalaciones deportivas:

Gestión de pistas, piscinas y estados

Reservas asociadas a usuarios

Hash de contraseñas con BCrypt

Arquitectura limpia y orientada a objetos
...
👟 Análisis Laboral de Nike (Investigación)

Trabajo académico profundizando en:

Legislación laboral

Relaciones empresa-trabajador

Aplicación de principios del derecho del trabajo
